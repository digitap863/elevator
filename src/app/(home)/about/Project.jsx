        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                >
                    ...
                    >
                        <div className="md:w-14 w-14 h-0.5 bg-[#376378] mt-3"></div>
                ...
                {/* Main Content */}
                <div className="flex md:flex-row flex-col w-full md:gap-12 gap-8 items-center">
                    {/* Left: Image */}
                    <motion.div
                    ...
                    >
                        <motion.div
                            ...
                            className="space-y-2"
                        >
                            <h5 className="text-black mb-1 uppercase md:text-2xl text-xl font-medium">ABC Corporate Tower</h5>
                            <p className="text-[#376378] text-lg">Actor Nadarsha's house</p>
                            <h5 className="text-[#376378] mb-1 uppercase md:text-2xl text-xl">home elevator</h5>
                        </motion.div>
                    </motion.div>
                </div>

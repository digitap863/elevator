  ...
  return (
    <div className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <h1 className="text-4xl font-medium font-satoshi text-[#000] pb-14">Elevators & <span className="text-gray-700">Escalators Solutions</span></h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {services.map((service, index) => (
            ...
            <div>
              ...
              {/* Get Started Link */}
              <button className="inline-flex items-center gap-2 text-red-600 hover:text-red-700 font-semibold text-sm group/btn transition-colors">
                Get Started

...
function Specilization() {
    ...
    return (
        <motion.section
            ...
            className="bg-white relative md:py-16 py-10 px-4 sm:px-6 lg:px-8 "
        >
            {/* white shadow top */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="mt-4 text-gray-600 max-w-4xl mx-auto md:text-xl text-base">
                ...
                <motion.div
                    ...
                    className="md:mt-16 mt-12 text-center"
                >
